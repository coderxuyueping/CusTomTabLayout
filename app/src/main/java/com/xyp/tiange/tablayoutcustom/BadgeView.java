...
public class BadgeView extends TextView {
    ...
    private void init() {
        ...
        setPadding(dp2px(context, 5), dp2px(context, 1), dp2px(context, 5), dp2px(context, 1));
    ...
    public void setBackground(int dipRadius, int badgeColor) {
        int radius = dp2px(context, dipRadius);
    ...
    public void setBadgeMargin(int leftDipMargin, int topDipMargin, int rightDipMargin, int bottomDipMargin) {
        LayoutParams params = (LayoutParams) getLayoutParams();
        params.leftMargin = dp2px(context,leftDipMargin);
        params.topMargin = dp2px(context, topDipMargin);
        params.rightMargin = dp2px(context, rightDipMargin);
        params.bottomMargin = dp2px(context, bottomDipMargin);
        setLayoutParams(params);
    }
